...
<form action="/team1foodorderapp/orders?shipping=true" method="post">
  <table class="form-tbl" cellspacing="0">
    <tbody>
      ...
      <tr>
        ...
        <td><input id="email2" type="text" name="confirmemail" name="email2"  value="${cart.order.shippingAddress.confirmemail}" /></td>
      </tr>
        <tr>
        <th>&nbsp;</th>
